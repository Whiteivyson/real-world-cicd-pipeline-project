...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.18.96:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#ab-cicd-pipeline-alerts', //update and provide your channel name
